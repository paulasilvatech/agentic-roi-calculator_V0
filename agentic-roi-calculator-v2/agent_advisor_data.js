/* ============================================================================
  ...
  As of: 2026-07-06 · All token prices are US$ per 1M tokens · 1 AI Credit = US$ 0.01
...
(function () {
  ...
  const GITHUB_COPILOT = {
    ...
    pricing: {
      ...
      anthropic: [
        ...
        { model: 'Claude Sonnet 5', status: 'GA', category: 'Versatile', input: 2.00, cachedInput: 0.20, cacheWrite: 2.50, output: 10.00, note: 'promotional pricing through August 31, 2026' },
        ...
        { model: 'Claude Opus 4.8 (fast mode) (preview)', status: 'GA', category: 'Powerful', input: 10.00, cachedInput: 1.00, cacheWrite: 12.50, output: 50.00 },
        { model: 'Claude Fable 5', status: 'GA', category: 'Powerful', input: 10.00, cachedInput: 1.00, cacheWrite: 12.50, output: 50.00 },
      ],
      google: [
      ...
      github: [
        { model: 'Raptor mini', status: 'GA', category: 'Versatile', input: 0.25, cachedInput: 0.025, output: 2.00 },
      ],
      microsoft: [
        { model: 'MAI-Code-1-Flash', status: 'GA', category: 'Lightweight', input: 0.75, cachedInput: 0.075, output: 4.50 },
      ],
      moonshot: [
        { model: 'Kimi K2.7 Code', status: 'GA', category: 'Versatile', input: 0.95, cachedInput: 0.19, output: 4.00 },
      ],
    },
  ...
  const PROVIDER_LABEL = { anthropic: 'Anthropic', openai: 'OpenAI', google: 'Google', github: 'GitHub', microsoft: 'Microsoft', moonshot: 'Moonshot AI' };
  ...
  const ENGINE_CATALOG = [
    ...
    { name: 'Claude Opus 4.8 (fast mode) (preview)', tier: 'premium' },
    { name: 'Claude Fable 5', tier: 'premium' },
    // OpenAI
